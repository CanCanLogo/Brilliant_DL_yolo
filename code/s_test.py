...
if __name__ == "__main__":
    ...
    # 50
    pth_path = r"D:\new_program\pythonProject\pytorchUse\DeepLearning\Exp4\runs\detect\train5\weights\best.pt"
    # Load a model
    # model = YOLO('yolov8n.pt')  # load an official model
    model = YOLO(pth_path)  # load a custom model
    ...
    for result in results:
        ...
        for box in boxes:
            ...
            # print(class_id)
            # print(names[class_id]) # 注意TypeError: 'dict' object is not callable是因为圆括号
    ...
    with open("test_result_s.json", 'w', encoding='utf-8') as f:
    ...
    predictions_path = "test_result_s.json"
...
Precsion: 0.9741935483870968
Recall: 0.5592592592592592
F1 Score: 0.7105882352941175
'''
