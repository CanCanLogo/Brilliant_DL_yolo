...
if __name__ == "__main__":
    ...
    # 50
    pth_path = r"D:\new_program\pythonProject\pytorchUse\DeepLearning\Exp4\runs\detect\train4\weights\best.pt"
    # Load a model
    # model = YOLO('yolov8n.pt')  # load an official model
    model = YOLO(pth_path)  # load a custom model
    ...
    with open("test_result_m.json", 'w', encoding='utf-8') as f:
    ...
    predictions_path = "test_result_m.json"
