...
if __name__ == "__main__":
    # Load a model
    model_yaml = r"D:\new_program\pythonProject\pytorchUse\DeepLearning\ultralytics-main\ultralytics\cfg\models\v8\yolov8m.yaml"

    data_yaml = r"D:\new_program\pythonProject\pytorchUse\DeepLearning\data_exp4\yolo\yolo\mydata.yaml"

    pre_model = r"D:\new_program\pythonProject\pytorchUse\DeepLearning\Exp4\yolov8m.pt"
